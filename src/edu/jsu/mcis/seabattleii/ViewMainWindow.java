...
public class ViewMainWindow extends JFrame implements AbstractView {
    ...
    public void modelPropertyChange(final PropertyChangeEvent e) {
        ...
        else if ((e.getPropertyName().equals(DefaultController.PLAYER1_FLEET_SUNK) && currentPlayer == 1) ||
                (e.getPropertyName().equals(DefaultController.PLAYER2_FLEET_SUNK) && currentPlayer == 2)) {

            showCard(EMPTY_CARD);
            JOptionPane.showMessageDialog(this, "Player " + otherPlayer() + " Wins!");
        ...
        else if ( (e.getPropertyName().equals(DefaultController.PLAYER1_ALREADY_HIT)) || 
                  (e.getPropertyName().equals(DefaultController.PLAYER2_ALREADY_HIT))) {
                
            JOptionPane.showMessageDialog(this, "This square has already been HIT!\nSelect a different square.");
