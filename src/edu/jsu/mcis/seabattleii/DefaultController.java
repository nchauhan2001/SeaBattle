...
public class DefaultController extends AbstractController
{
    ...
    public static final String PLAYER1_FLEET_SUNK = "Player1FleetSunk";
    public static final String PLAYER2_FLEET_SUNK = "Player2FleetSunk";

    public static final String PLAYER1_ALREADY_HIT = "Player1AlreadyHit";
    public static final String PLAYER2_ALREADY_HIT = "Player2AlreadyHit";
